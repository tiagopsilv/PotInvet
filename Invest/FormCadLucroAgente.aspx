<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCadLucroAgente.aspx.cs" Inherits="Invest.FormCadLucroAgente" %>
...
<body>
    ...
    <div style="height: 1456px; padding-left: 150px; padding-top: 10px; background-color: #ebe7e8;">
        <h2>
            Cadastro de Lucro</h2>
        <div style="float: left;">
        <asp:Label ID="lblErro1" runat="server" Text="Erro:" ForeColor="Red" 
                Visible="False"></asp:Label>&nbsp;</br>

            <asp:Label ID="Label1" runat="server" Text="Descrição do Lucro" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtDescLucro" runat="server" Width="500px" Height="78px"
                Style="border: 0;" MaxLength="50" TextMode="MultiLine"></asp:TextBox>
            <br />
            <br />
             <asp:Label ID="Label2" runat="server" Text="Valor Estimado" 
            ...
            <br />
             <asp:Label ID="Label4" runat="server" Text="Justificativa para o Valor" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtJustiLucro" runat="server" Width="502px" Height="66px" 
                Style="border: 0;" MaxLength="30" TextMode="MultiLine"></asp:TextBox>
            <br />
            <br />
             <asp:Label ID="Label7" runat="server" Text="Data Prevista" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
