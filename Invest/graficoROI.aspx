<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="graficoROI.aspx.cs"
    Inherits="Invest.graficoROI" %>
...
<body>
    ...
    <div class="header">
        ...
        <table>
            ...
            <td style="width: 200px;">
                <asp:LinkButton ID="linkButton1" runat="server" Text="My Home" 
    ...
    <div style="height: 900px; padding-left: 150px; padding-top: 10px; background-color: #ebe7e8;">
        <h2>
            Acompanhamentos - 2012
        </h2>
        <tr>
        <td style="width: 200px; background-color: #b8b2ae; padding-left: 20px; padding-right: 20px;">
        <h3>Julho - 2012</h3>
            <img src="Imagens/graficoROI.jpg" />
        <td style="width: 200px; background-color: #b8b2ae; padding-left: 20px; padding-right: 20px;">
        <h3>Agosto - 2012</h3>
            <img src="Imagens/graficoROI.jpg" />
        <td style="width: 200px; background-color: #b8b2ae; padding-left: 20px; padding-right: 20px;">
