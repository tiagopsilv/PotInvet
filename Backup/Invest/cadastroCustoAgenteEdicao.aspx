<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastroCustoAgenteEdicao.aspx.cs"
    Inherits="Invest.cadastroCustoAgenteEdicao" %>
...
<body>
    ...
    <div style="padding-left: 50px; background-color: #ebe7e8;" class="conteudo">
        <table cellpadding="3" cellspacing="3" style="margin-left: 0px; width: 913px;">
            <tr>
