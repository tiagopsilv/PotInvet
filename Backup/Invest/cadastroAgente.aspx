<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastroAgente.aspx.cs"
    Inherits="Invest.cadastroAgente" %>
...
<asp:Label ID="Label15" runat="server" Text="DDD" 
            ...
            <br />
            <br />
            <asp:LinkButton ID="lnkLucro" runat="server" onclick="lnkLucro_Click">Lista de Lucro</asp:LinkButton>
            &nbsp;
            <asp:Label ID="lblTotalLucro" runat="server" Text="TotalLucro" Visible="False"></asp:Label>
            <br />
            <asp:LinkButton ID="lnkCusto" runat="server" onclick="lnkCusto_Click">Lista Custo</asp:LinkButton>
            &nbsp;
            <asp:Label ID="lblTotalCusto" runat="server" Text="TotalCusto" Visible="False"></asp:Label>
            <br />
&nbsp;<br />
