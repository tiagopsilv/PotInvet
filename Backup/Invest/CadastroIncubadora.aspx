<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroIncubadora.aspx.cs" Inherits="Invest.CadastroIncubadora" %>
...
<body>
    ...
    <br />
    <br />
    <div style="height: 1335px; padding-left: 150px; padding-top: 10px; background-color: #ebe7e8;">
        <h2>
            Cadastro de Agente
        </h2>
        ...
        Visible="False"></asp:Label>&nbsp;</br>
            <asp:Label ID="Label1" runat="server" Text="Nome do Agente" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtNomeAgente" runat="server" Width="464px" Height="20px"
                Style="border: 0;" MaxLength="50"></asp:TextBox>
            <asp:Label ID="lblObriUsuario3" runat="server" Text="*"></asp:Label>
            <br />
             <br />
             <table width="458" border="0" style="height: 45px" cellpadding="0" cellspacing="0">
  <tr>
    <td class="style1">
                    <asp:Label ID="lblCNPJ" runat="server" BorderStyle="None" Font-Size="Medium" 
                        Text="CNPJ"></asp:Label>
                    </td>
    <td width="37">ou</td>
    <td width="203">
                    <asp:Label ID="lblCPF" runat="server" BorderStyle="None" Font-Size="Medium" 
                        Text="CPF" Height="16px"></asp:Label>
                        </td>
  </tr>
  <tr>
    <td class="style1">
                    <asp:TextBox ID="txtCNPJ" runat="server" Height="20px" MaxLength="22" 
                    onKeyDown="formataCNPJ(this,event);" onKeyPress="formataCNPJ(this,event);" onKeyUp="formataCNPJ(this,event);" 
                        Style="border: 0;" Width="174px"></asp:TextBox>
                    </td>
    <td>&nbsp;</td>
    <td>
                    <asp:TextBox ID="txtCPF" runat="server" Height="16px" MaxLength="14" 
                    onKeyDown="formataCPF(this,event);" onKeyPress="formataCPF(this,event);" onKeyUp="formataCPF(this,event);" 
                        Style="border: 0;" Width="140px"></asp:TextBox>
                    </td>
  </tr>
</table>
            <br />
             ...
             <asp:Label ID="lblEmail" runat="server" Text="Email" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtEmail" runat="server" Width="447px" Height="20px" 
                Style="border: 0;" MaxLength="50"></asp:TextBox>
            <asp:Label ID="lblObriUsuario2" runat="server" Text="*"></asp:Label>
            <br />
            <br />
             ...
             <asp:Label ID="Label5" runat="server" Text="Telefone" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtDDDTel" runat="server" Width="30" Height="20" 
                onkeyup="formataInteiro(this,event);" Style="border: 0;" MaxLength="3"></asp:TextBox>
                &nbsp;&nbsp;
            <asp:TextBox ID="txtTel" runat="server" Width="150" Height="20" 
                Style="border: 0;" MaxLength="15"></asp:TextBox>
            <asp:Label ID="lblObriUsuario1" runat="server" Text="*"></asp:Label>
            <br />
            <br />
             ...
             <asp:Label ID="Label9" runat="server" Text="Celular" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtDDDCel" runat="server" Width="30" Height="20" 
                onkeyup="formataInteiro(this,event);" Style="border: 0;" MaxLength="2"></asp:TextBox>
                &nbsp;&nbsp;
            <asp:TextBox ID="txtCel" runat="server" Width="150" Height="20" 
                Style="border: 0;" MaxLength="15"></asp:TextBox><br />
            <br />
             <asp:Label ID="Label10" runat="server" Text="Endereço" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtEndereco" runat="server" Width="480px" Height="20px" 
                Style="border: 0;" MaxLength="60"></asp:TextBox>
            <asp:Label ID="lblObriUsuario0" runat="server" Text="*"></asp:Label>
            <br />
            <br />
             <asp:Label ID="Label8" runat="server" Text="Complemento" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:TextBox ID="txtComplemento" runat="server" Width="477px" Height="20px" 
            ...
            <br />
             <asp:Label ID="Label13" runat="server" Text="UF" 
                BorderStyle="None" Font-Size="Medium"></asp:Label>
            <br />
            <asp:DropDownList ID="cboEstado" runat="server" Height="16px" Width="152px">
          ...
          <%--  <asp:TextBox ID="TextBox13" runat="server" Width="400" Height="30" 
            ...
            <asp:TextBox ID="txtCidade" runat="server" Width="250" Height="20" 
                Style="border: 0;" MaxLength="25"></asp:TextBox><br />
            </br>
            ...
            <asp:Label ID="Label19" runat="server" Text="Senha" 
                BorderStyle="None" Font-Size="Medium"></asp:Label></br>
            ...
            <br />
            <br />
            <asp:Label ID="Label16" runat="server" Text="Logo" BorderStyle="None" 
                Font-Size="Medium"></asp:Label>
            <br />
            <asp:FileUpload ID="fupLogo" runat="server" Width="217px" />
            <br />
            <br />
...
(iii) Confirmada a validação, será distribuído eletronicamente ao Agente um Documento de Identificação de Investidor do Projeto, bem como as formas de contato direto com o Agente. Serão reproduzidas todas as condições de uso e/ou entrega, para que os projetos sejam recebidos pelo Investidor do projeto.
...
8. Fica expressamente proibida a utilização total, ou parcial de qualquer projeto divulgado no Idéias Invest, sem a devida autorização do Agente. Podendo ser aplicadas as devidas implicações de acordo com a LEI Nº 9.610, DE 19 DE FEVEREIRO DE 1998. (Direitos Autorais).</asp:TextBox>
            </br>
            </br>
            ...
            <asp:ImageButton ID="btnSalvar" runat="server" 
                ImageUrl="~/Imagens/botaoSalvar.jpg" style="text-align: left" 
